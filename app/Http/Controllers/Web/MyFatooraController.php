...
// dd(config('myfatoora.pk'));
        ...
        // $token = "JvNm1stkd4SkgqynBs1A49ba-mkL-G7L-_cZHAPNEMGP4gim7BUP4a9qBwPU4DywG0Qk2lj4cTdGFHwfv0CmQM0hWGVB2b2rHugNuRS_I6GrG6h3lYt5wct3SaqFYJvbq4NYuEUco7V_gzyeHZtnYIGXr3RHiwxx1ryZAMKRTEX57-zr7eQaXPkcLLOZXMeSuMGNYsWxedFsc2Lz4XHXOdxNYpmVsG9BkGfk0zODEV_cEP5yfHJaaeyElcYB8uztOts3MD_RLzQNhM5710E78l-dlEZ9XNOhE09Cs_BRRkGS-wOATgt9pu7ALqOl_J_Xloa5vBCP2AdNXkKSLJKZlRW7udIPMhFrfoJHdaE_lNUz7PdjPzaFSTuQ45WGcr2-26rIh26KtIeKTavePC_mZcYDIi0puaXLI21csSWnTzGfRh1f-0MKZxDWGrHNv9Htr5GfY10J69H5HzdtLscUYZ_0MWfiZ4Hteu91N0897KDhobEiXGWo-PfCbDdRD9v-xdUEpnFADM5XpTkhrrhTs8tejYcvMknvXJ_3of3grA8AwpJMBnntJhkCQWPfx-JIvZWeRtLH1Odt__ZqUKrclg_9-qjVC9toYrPlmOTS1gJan7dEz8hW3L7lsg9SOWIuewSpJ3C6THWnmF4QHvoLu7-Y8FE4YIPDGrfq1emMarVWhJxIWizxgJJ_9Uy2BRYZY87y3w";
        ...
        if ($response->successful()) {
            ...
            // dd($response->json(),$payment_methods);
         ...
         if ($payment_for=="wallet") {
            ...
            $wallet_add_history_model::create([
                ...
                $request_detail->update(['is_paid' => true]);
                    ...
                    $additional_charges_amount = $bill_detail->additional_charges_amount;

...
class DriverFilter implements FilterContract {
	...
	public function filters() {
		return [
			'approve','service_location_id','transport_type','vehicle_type','owner_id','fleet_vehicle_type','driver_id','driver_service_location','upload_pending'
		];
	}
    /**
    ...
    */
    ...
    public function upload_pending($builder,$value=null)
    {
        ...
        $builder->withCount('driverDocument')->having('driver_document_count', $value ? '<' : '=', $needed_count);
    }
}

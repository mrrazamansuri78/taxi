...
Route::group(['prefix' => 'drivers-levelup', 'middleware' => 'permission:view-drivers-levelup'], function () {
    ...
    Route::delete('/delete/{level}', [DriverManagementController::class, 'driverLevelDelete'])->name('approveddriver.driverLevelDelete');
      Route::middleware(['permission:add-drivers-levelup'])->get('/create/{zoneType}', [DriverManagementController::class, 'create'])->name('driverlevelup.create');
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['permission:view-web-support-ticket-detail'])->get('/ticket/view/{supportTicket}', [UserWebBookingController::class, 'viewTicketDetails'])->name('ticket.viewDetails');
